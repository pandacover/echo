...
export function QuotaPill({ remainingSeconds }: { remainingSeconds: number }) {
  ...
  return (
    <p
      role="status"
      className={`pointer-events-auto flex h-11 items-center rounded-full border px-3.5 text-[13px] font-medium shadow-[0_8px_20px_rgba(28,23,20,0.08)] backdrop-blur-xl ${
        depleted
